...
public class BuildDao {
    ...
    public DataTable getAllBuilds(){
        String sql="select a.F_UUID,a.F_BUILDCODE,a.F_BUILDNAME,b.F_GROUPNAME,b.F_UUID GROUPID,d.F_NAME,d.F_CODE,a.F_TOTALAREA,a.F_PEOPLE,a.F_AIRAREA,a.F_BUILDYEAR,a.F_UPFLOOR,a.F_DOWNFLOOR,a.F_ZEROFLOOR from T_BD_BUILD a,T_BD_GROUP b,T_BD_GROUPBUILDRELA c,T_BD_BUILDTYPE d " +
                "where a.F_UUID=c.F_BUILDID AND b.F_UUID=c.F_BUILDGROUPID AND a.F_BUILDFUNC=d.F_CODE";
        ...
        jdbcTemplate.query(sql, new RowCallbackHandler (){
            ...
            public void processRow(ResultSet rs)throws SQLException{
                ...
                build.setId(rs.getString("F_UUID"));
                build.setCode(rs.getString("F_BUILDCODE"));
                build.setName(rs.getString("F_BUILDNAME"));
                build.setGroup(rs.getString("F_GROUPNAME"));
                build.setGroupid(rs.getString("GROUPID"));
    ...
    public void addBuild(Build build){
        ...
        String sql1="insert into T_BD_GROUPBUILDRELA(F_BUILDID,F_BUILDGROUPID,F_OPERATION) values(?,?,'N')";
        Object[] args1={build.getId(),build.getGroupid()};
        jdbcTemplate.update(sql1, args1);

        String sql="insert into T_BD_BUILD(F_UUID,F_BUILDCODE,F_BUILDNAME,F_BUILDFUNC,F_TOTALAREA,F_PEOPLE,F_AIRAREA,F_BUILDYEAR,F_UPFLOOR,F_DOWNFLOOR,F_ZEROFLOOR,F_OPERATION) values(?,?,?,?,?,?,?,?,?,?,?,'N')";
        Object[] args={UUID.randomUUID().toString(),build.getId(),build.getCode(),build.getName(),build.getBuildtypeid(),build.getArea(),build.getPeople(),build.getAirarea(),build.getYear(),build.getUpfloor(),build.getDownfloor(),build.getZerofloor()};
    ...
    public void deleteBuild(String id){
        ...
        String sql="UPDATE T_BD_BUILD SET F_STATUS='00Z' where F_UUID=?";
        Object[] args={id};
        jdbcTemplate.update(sql,args);
        String sql1="UPDATE T_BD_GROUPBUILDRELA SET F_STATUS='00Z' where F_BUILDID=?";
        Object[] args1={id};
        jdbcTemplate.update(sql1,args1);
        String sql2 = "UPDATE T_BD_FLOOR SET F_STATUS='00Z' where F_BUILDID=?";
        Object[] args2 = { id };
        jdbcTemplate.update(sql2, args2);
        String sql3 = "UPDATE T_BD_ROOM SET F_STATUS='00Z' where F_FLOORID in (select F_UUID from T_BD_FLOOR where F_BUILDID=?)";
        Object[] args3 = { id };
    ...
    public Build getBuildById(String id){
        String sql="select a.F_UUID,a.F_BUILDCODE,a.F_BUILDNAME,b.F_GROUPNAME,b.F_UUID GROUPID,d.F_CODE,d.F_NAME,a.F_TOTALAREA,a.F_AIRAREA,a.F_BUILDYEAR,a.F_UPFLOOR,a.F_DOWNFLOOR,a.F_ZEROFLOOR from T_BD_BUILD a,T_BD_GROUP b,T_BD_GROUPBUILDRELA c,T_BD_BUILDTYPE d " +
                "where a.F_UUID=? AND a.F_UUID=c.F_BUILDID AND b.F_UUID=c.F_BUILDGROUPID AND a.F_BUILDFUNC=d.F_CODE";
        Object[] args={id};
        ...
        jdbcTemplate.query(sql, args ,new RowCallbackHandler(){
            ...
            public void processRow(ResultSet rs)throws SQLException{
                ...
                build.setName(rs.getString("F_BUILDNAME"));
                build.setGroup(rs.getString("F_GROUPNAME"));
                build.setGroupid(rs.getString("F_GROUPID"));
                build.setBuildtypeid(rs.getString("F_CODE"));
                build.setBuildtype(rs.getString("F_NAME"));
                build.setArea(rs.getDouble("F_TOTALAREA"));
                build.setAirarea(rs.getDouble("F_AIRAREA"));
    ...
    public Build getBuildByName(String name){
        String sql="select a.F_UUID,a.F_BUILDNAME,b.F_GROUPNAME,b.F_UUID GROUPID,d.F_CODE,d.F_NAME,a.F_TOTALAREA,a.F_AIRAREA,a.F_BUILDYEAR,a.F_UPFLOOR+a.F_DOWNFLOOR+a.F_ZEROFLOOR as FLOOR from T_BD_BUILD a,T_BD_GROUP b,T_BD_GROUPBUILDRELA c,T_BD_BUILDTYPE d " +
                "where a.F_BUILDNAME=? AND a.F_UUID=c.F_BUILDID AND b.F_UUID=c.F_BUILDGROUPID AND a.F_BUILDFUNC=d.F_CODE";
        Object[] args={name};
        final Build build=new Build();
        jdbcTemplate.query(sql, args ,new RowCallbackHandler(){
            @Override
    ...
    public void updateBuildById(Build build){
        ...
        String sql="update T_BD_BUILD set F_BUILDCODE=?,F_BUILDNAME=?,F_BUILDFUNC=?,F_TOTALAREA=?,F_PEOPLE=?,F_AIRAREA=?,F_BUILDYEAR=?,F_UPFLOOR=?,F_DOWNFLOOR=?,F_ZEROFLOOR=?,F_OPERATION='U' where F_UUID=?";
        ...
        jdbcTemplate.update(sql,args);
        String sql1="update T_BD_GROUPBUILDRELA set F_BUILDGROUPID=?,F_OPERATION='U' WHERE F_BUILDID=?";
    ...
    public void addFloor(Floor floor) {
        ...
        jdbcTemplate.update(sql, args);
        if(floor.getCode()>0){
            sql="update T_BD_BUILD set f_upfloor = f_upfloor +1 where f_buildid=?";
        }
        else if(floor.getCode()<0){
            sql="update T_BD_BUILD set f_downfloor = f_downfloor +1 where f_buildid=?";
        }
        else
            sql="update T_BD_BUILD set f_zerofloor = 1 where f_buildid=?";
    ...
    public void deleteFloor(String ids) {
        ...
        if(ids.split(",")[1].equals("upfloor")){
            sql="update T_BD_BUILD set f_upfloor = f_upfloor - 1 where f_buildid=(select f_buildid from T_BD_FLOOR where f_id=?)";
        }
        else
        if(ids.split(",")[1].equals("downfloor")){
            sql="update T_BD_BUILD set f_downfloor = f_downfloor - 1 where f_buildid=(select f_buildid from T_BD_FLOOR where f_id=?)";
        }
        else
            sql="update T_BD_BUILD set f_zerofloor = 0 where f_buildid=(select f_buildid from T_BD_FLOOR where f_id=?)";
        Object[] args2 = {id};
    ...
    public List<Options> getGroupNames(){
        String sql="select F_BUILDGROUPID,F_BUILDGROUPNAME FROM T_BD_GROUP ORDER BY F_BUILDGROUPNAME";
    ...
    public List<Options> getBuildsByGroupId(String id){
        final List<Options> options = new ArrayList<Options>();
        if(id.equals("all")){
            String sql = "select a.F_BUILDID,a.F_BUILDNAME,c.F_BUILDGROUPNAME FROM T_BD_BUILD a,T_BD_GROUPBUILDRELA b,T_BD_GROUP c WHERE a.F_BUILDID=b.F_BUILDID AND b.F_BUILDGROUPID=c.F_BUILDGROUPID ORDER BY c.F_BUILDGROUPNAME,a.F_BUILDNAME";
            jdbcTemplate.query(sql, new RowCallbackHandler() {
                @Override
                public void processRow(ResultSet rs) throws SQLException {
                    Options option = new Options();
            ...
            String sql = "select a.F_BUILDID,a.F_BUILDNAME FROM T_BD_BUILD a,T_BD_GROUPBUILDRELA b,T_BD_GROUP c WHERE a.F_BUILDID=b.F_BUILDID AND b.F_BUILDGROUPID=c.F_BUILDGROUPID AND c.F_BUILDGROUPID=? ORDER BY F_BUILDNAME";
            Object[] args = {id};
            jdbcTemplate.query(sql, args, new RowCallbackHandler() {
                @Override
                public void processRow(ResultSet rs) throws SQLException {
    ...
    public List<Options> getBuildsByFunc(String id){
        String sql="select F_BUILDID,F_BUILDNAME FROM T_BD_BUILD  WHERE F_BUILDFUNC=? ORDER BY F_BUILDNAME";
        Object[] args={id};
        final List<Options> options=new ArrayList<Options>();
        jdbcTemplate.query(sql, args, new RowCallbackHandler(){
            @Override
    ...
    public List<Tree> getSchoolTree(){
        String sql4="select b.F_BUILDGROUPID,b.F_BUILDGROUPNAME FROM T_BE_EQUIPMENTLIST a,T_BD_GROUP b,T_BD_GROUPBUILDRELA c WHERE a.F_BUILDID(+)=c.F_BUILDID AND b.F_BUILDGROUPID=c.F_BUILDGROUPID  GROUP BY b.F_BUILDGROUPID,b.F_BUILDGROUPNAME ORDER BY b.F_BUILDGROUPNAME";
        String sql0="select c.F_BUILDGROUPID,b.F_BUILDNAME,b.F_BUILDID FROM T_BE_EQUIPMENTLIST a,T_BD_BUILD b,T_BD_GROUP c,T_BD_GROUPBUILDRELA d WHERE a.F_BUILDID(+)=b.F_BUILDID AND b.F_BUILDID=d.F_BUILDID AND c.F_BUILDGROUPID=d.F_BUILDGROUPID GROUP BY c.F_BUILDGROUPID,b.F_BUILDNAME,b.F_BUILDID ORDER BY b.F_BUILDNAME";
        ...
        jdbcTemplate.query(sql4, new RowCallbackHandler(){
            ...
            public void processRow(ResultSet rs)throws SQLException{
                ...
                buildTree.setParent("allofsumgroup");
                buildTrees.add(buildTree);
            }
        });
