...
ecss.energy=(function(){
    ...
    setJqueryMap=function(){
        ...
        jqueryMap={
            $container  :$container,
            $portlet1    :new ecss.tools.makePortlet($container.find('#energyitem'),'电能分项','blue','',configMap.energyitem),
            $portlet2    :new ecss.tools.makePortlet($container.find('#condition'),'查询条件','orange','',configMap.condition),
            $portlet3    :new ecss.tools.makePortlet($container.find('#display'),'能耗展示','green','',configMap.display),
    ...
    setAim=function () {
        ...
        configMap.urlOption.modelid='j4_2';
        ...
        $.each(jqueryMap.$energyitemtree.get_checked(),function(index,item){
            ...
            modelMap.modelenergy.post('getenergy',function(data){
                ...
                if(data.energy.data!=null&&data.energy.data.length>0){
                    ...
                    configMap.chartOption.yAxis[0].name = "总耗电量:"+data.energy.data.reduce(function(a,b){return a+b;}).toFixed(4)+'度';
