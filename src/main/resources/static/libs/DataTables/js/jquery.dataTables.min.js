...
iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": 以升序排列此列",sSortDescending:": 以降序排列此列"},oPaginate:{sFirst:"首页",sLast:"末页",sNext:"下一页",sPrevious:"上一页"},sEmptyTable:"表中数据为空",sInfo:"显示第 _START_ 至 _END_条信息，共 _TOTAL_条",sInfoEmpty:"显示第 0 至 0 条信息，共 0 条",sInfoFiltered:"(由 _MAX_ 条信息过滤)",sInfoPostFix:"",sDecimal:"",
sThousands:",",sLengthMenu:"每页显示 _MENU_ 条信息",sLoadingRecords:"载入中...",sProcessing:"处理中...",sSearch:"搜索:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"没有匹配结果"},oSearch:g.extend({},p.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",searchDelay:null,sPaginationType:"simple_numbers",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET",renderer:null};V(p.defaults);p.defaults.column={aDataSort:null,iDataSort:-1,asSorting:["asc","desc"],bSearchable:!0,
